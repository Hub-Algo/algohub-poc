...
import CategoryBadge, { CategoryBadgePropsInterface } from '../../CategoryBadge'
    ...
    <div className="w-full bg-gray-950 rounded-md p-6 gap-6 flex flex-col col-span-4">
      <div className="flex flex-col gap-5">
        ...
        <div>
          ...
          <h2 className="text-xl md:text-4xl font-bold text-gray-100 ">${campaign?.record.fundraisingGoal.minAmount}</h2>
        </div>
      </div>
